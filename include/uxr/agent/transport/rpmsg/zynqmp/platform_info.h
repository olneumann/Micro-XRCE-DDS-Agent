...
#include <uxr/agent/transport/rpmsg/zynqmp/platform_info_common.h>
...
#define RPU_CPU_ID              0 /* RPU remote CPU Index. */
#define IPI_CHN_BITMASK         0x00000100
#define IPI_DEV_NAME            "ff340000.ipi"

#define DEV_BUS_NAME            "platform" /* device bus name. "platform" bus is used in Linux kernel for generic devices */

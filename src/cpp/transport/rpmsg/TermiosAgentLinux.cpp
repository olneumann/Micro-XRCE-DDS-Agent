...
namespace eprosima
{
    namespace uxr
    {
        TermiosRPMsgAgent::TermiosRPMsgAgent(
            ...
            : RPMsgAgent(addr, middleware_kind), dev_{dev}, open_flags_{open_flags}, termios_attrs_{termios_attrs}
        {
        }
        ...
        bool TermiosRPMsgAgent::init()
        {
            ...
            UXR_PRINTF("RPMsg init...", NULL);
            UXR_PRINTF("OpenAMP version: ", openamp_version());
            UXR_PRINTF("Libmetal version: ", metal_ver());
        ...
        bool TermiosRPMsgAgent::handle_error(TransportRc /*transport_rc*/)
        {
            return fini() && init();
        }
